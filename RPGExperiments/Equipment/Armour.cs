...
namespace RPGExperiments.Equipment
{
    ...
    {                          
        ...
        public static List<Armour> Armour = new List<Armour> {ThiefCape, GoddessSuit, CrimsonHat, CrusaderHeavy, PurpleRobes, CrimsonUniform, ThiefSuit, AzureCloak, SteelLight, WhiteRobes};
    }
