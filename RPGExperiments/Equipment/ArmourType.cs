...
namespace RPGExperiments.Equipment
{
    public static class ArmourTypes
    {
        ...
        public static readonly ArmourType LightOutfit = new ArmourType(1.0, 0.8, 1.2);
        public static readonly ArmourType MediumOutfit = new ArmourType(1.0, 0.9, 1.1);
        public static readonly ArmourType LightRobes = new ArmourType(1.0, 1.1, 1.1);
